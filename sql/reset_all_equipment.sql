...
CREATE OR REPLACE FUNCTION public.reset_all_equipment () RETURNS void AS
$BODY$
    DECLARE
    ...
    BEGIN
        ...
        DELETE FROM tue4_bm_assets WHERE ord_id IS NOT NULL;
        
        DELETE FROM tue4_gear_instance WHERE gei_bas_id IS NOT NULL AND gei_bas_id NOT IN (SELECT bm_asset_id FROM tue4_bm_assets);
